...
execute if entity @s[tag=red] as @a[team=red] run function #game:events/change_sword
execute if entity @s[tag=blue] as @a[team=blue] run function #game:events/change_sword
execute if entity @s[tag=green] as @a[team=green] run function #game:events/change_sword
execute if entity @s[tag=yellow] as @a[team=yellow] run function #game:events/change_sword