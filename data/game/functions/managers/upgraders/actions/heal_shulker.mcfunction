...
execute if entity @s[tag=red] as @e[type=minecraft:shulker,team=red] run function game:resources/views/shulker_health
execute if entity @s[tag=blue] as @e[type=minecraft:shulker,team=blue] run function game:resources/views/shulker_health
execute if entity @s[tag=green] as @e[type=minecraft:shulker,team=green] run function game:resources/views/shulker_health
execute if entity @s[tag=yellow] as @e[type=minecraft:shulker,team=yellow] run function game:resources/views/shulker_health