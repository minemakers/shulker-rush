...
execute if score @s shulker_health matches 7.. run scoreboard players set #error var 3
execute if score @s shulker_health matches ..0 run scoreboard players set #error var 4
