...
execute if score $status var matches 2 if score $arena var matches 1 run spawnpoint @s 1028 251 53
execute if score $status var matches 2 if score $arena var matches 2 run spawnpoint @s 2071 239 -1
execute if score $status var matches 2 if score $arena var matches 3 run spawnpoint @s 3017 254 -14
