...
data modify storage game:tmp players append value {bit0:0b,bit1:0b,bit2:0b,bit3:0b,bit4:0b,bit5:0b,bit6:0b,selected:0b}
execute if entity @s[tag=bit0] run data modify storage game:tmp players[-1].bit0 set value 1b
execute if entity @s[tag=bit1] run data modify storage game:tmp players[-1].bit1 set value 1b
execute if entity @s[tag=bit2] run data modify storage game:tmp players[-1].bit2 set value 1b
execute if entity @s[tag=bit3] run data modify storage game:tmp players[-1].bit3 set value 1b
execute if entity @s[tag=bit4] run data modify storage game:tmp players[-1].bit4 set value 1b
execute if entity @s[tag=bit5] run data modify storage game:tmp players[-1].bit5 set value 1b
execute if entity @s[tag=bit6] run data modify storage game:tmp players[-1].bit6 set value 1b