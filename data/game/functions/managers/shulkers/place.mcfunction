...
execute if score #shulker_type var matches 1 store success score #success var if predicate game:locations/blue_island run function game:resources/prefabs/shulkers/variants/blue
execute if score #shulker_type var matches 2 store success score #success var if predicate game:locations/green_island run function game:resources/prefabs/shulkers/variants/green
execute if score #shulker_type var matches 3 store success score #success var if predicate game:locations/red_island run function game:resources/prefabs/shulkers/variants/red
