...
# Make interaction show up if there's amethyst
execute if block ~ ~ ~ minecraft:air run tp @e[type=minecraft:interaction,tag=crystal_hitbox,distance=..2,limit=1] ~ ~-0.6 ~
