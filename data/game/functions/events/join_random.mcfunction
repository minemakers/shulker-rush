...
execute if score #red_players var < #limit var run tag @e[type=minecraft:villager,tag=team,tag=red,limit=1] add available
execute if score #blue_players var < #limit var run tag @e[type=minecraft:villager,tag=team,tag=blue,limit=1] add available
execute if score #green_players var < #limit var run tag @e[type=minecraft:villager,tag=team,tag=green,limit=1] add available
...
execute if entity @e[type=minecraft:villager,tag=team,tag=selected,tag=red] run advancement grant @s only game:join_team red
...
execute if entity @e[type=minecraft:villager,tag=team,tag=selected,tag=green] run advancement grant @s only game:join_team green
