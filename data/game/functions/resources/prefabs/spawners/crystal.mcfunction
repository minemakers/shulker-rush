...
summon minecraft:slime ~ ~-1.6 ~ {Size:1,NoAI:1b,Silent:1b,ActiveEffects:[{ShowParticles:0b,Id:11,Duration:9999999,Amplifier:5b},{ShowParticles:0b,Id:14,Duration:9999999,Amplifier:1b}],Tags:["crystal_hitbox"]}