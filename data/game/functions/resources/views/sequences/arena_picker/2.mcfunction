...
execute if score $arena var matches 2 as @e[type=minecraft:armor_stand,tag=arena2] run data modify entity @s CustomName set from block 0 10 0 Text3
execute if score $arena var matches 3 as @e[type=minecraft:armor_stand,tag=arena3] run data modify entity @s CustomName set from block 0 10 0 Text3
