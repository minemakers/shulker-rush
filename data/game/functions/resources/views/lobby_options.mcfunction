...
data modify entity @e[type=minecraft:armor_stand,tag=lang_picker,limit=1] CustomName set from block 0 1 0 Text1
...
data modify entity @e[type=minecraft:armor_stand,tag=lang_picker_help,limit=1] CustomName set from block 0 1 0 Text1
