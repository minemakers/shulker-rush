...
execute if score @s spawner_level matches 0 run scoreboard players operation #timer.gold var /= $timer.gold.1 config
execute if score @s spawner_level matches 1 run scoreboard players operation #timer.gold var /= $timer.gold.2 config
execute if score @s spawner_level matches 2.. run scoreboard players operation #timer.gold var /= $timer.gold.3 config
...
execute if score @s spawner_level matches 0 run scoreboard players operation #timer.iron var /= $timer.iron.1 config
execute if score @s spawner_level matches 1 run scoreboard players operation #timer.iron var /= $timer.iron.2 config
execute if score @s spawner_level matches 2.. run scoreboard players operation #timer.iron var /= $timer.iron.3 config
