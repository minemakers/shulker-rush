...
summon minecraft:block_display 2026.5 216 -75.5 {Tags:["spawnpoint","blue"],Rotation:[0.0f,10.0f]}
summon minecraft:block_display 2026.5 216 74.5 {Tags:["spawnpoint","yellow"],Rotation:[180.0f,10.0f]}
