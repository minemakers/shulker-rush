...
execute if score $arena var matches 1 at @e[type=minecraft:text_display,tag=arena1] run tp @e[type=minecraft:item_display,tag=picker_arrow,sort=nearest,limit=1] ~ ~1.6 ~.35 0 0
execute if score $arena var matches 2 at @e[type=minecraft:text_display,tag=arena2] run tp @e[type=minecraft:item_display,tag=picker_arrow,sort=nearest,limit=1] ~.15 ~1.6 ~.3 -20 0
