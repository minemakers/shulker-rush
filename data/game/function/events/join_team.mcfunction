...
execute if entity @s[team=red] at @e[type=minecraft:interaction,tag=red] positioned ^ ^ ^-4 run tp @s ~ ~ ~ ~ ~7
execute if entity @s[team=blue] at @e[type=minecraft:interaction,tag=blue] positioned ^ ^ ^-4 run tp @s ~ ~ ~ ~ ~7
execute if entity @s[team=green] at @e[type=minecraft:interaction,tag=green] positioned ^ ^ ^-4 run tp @s ~ ~ ~ ~ ~7
